...
export default function EpisodePage() {
  const episode = episodes.find(ep => ep.id === 'cc-01');
  ...
  return (
    <div className="w-full min-h-screen pb-24">
      <div className="max-w-4xl mx-auto px-6 pt-10">
        <div className="mb-6">
          <Link href="/creator-capital" className="text-sm font-bold uppercase tracking-widest opacity-60 hover:opacity-100 transition-all" style={{ color: 'var(--text-primary)' }}>
            ← Back to Creator Capital
          </Link>
        </div>
        <div className="mb-4">
