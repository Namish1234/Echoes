      ...
      >
        ...
        <div className="p-4 border-t-4" style={{ borderColor: 'var(--border-color)' }}>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-black" style={{ backgroundColor: '#EF4444', color: '#fff' }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] font-bold uppercase tracking-widest" style={{ color: '#EF4444' }}>Admin</p>
            </div>
          </div>
          <Link href="/" className="flex items-center gap-2 mt-3 text-xs font-bold uppercase tracking-widest opacity-60 hover:opacity-100 transition-all" style={{ color: 'var(--text-primary)' }}>
            ← Back to Echoes
          </Link>
        </div>
      </aside>
