...
export default function EpisodePage() {
  const episode = figuringOutEpisodes.find(ep => ep.id === 'fo-narcissism');
  ...
  return (
    <div className="w-full min-h-screen pb-24">
      <div className="max-w-4xl mx-auto px-6 pt-10">
        <div className="mb-6">
          <Link href="/figuring-out" className="text-sm font-bold uppercase tracking-widest opacity-60 hover:opacity-100 transition-all" style={{ color: 'var(--text-primary)' }}>
