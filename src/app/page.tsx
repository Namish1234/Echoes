...
export default function EchoesLanding() {
  return (
    <div className="w-full">
      ...
      <section className="w-full border-b-4 border-wtf-black bg-wtf-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 divide-y-4 md:divide-y-0 md:divide-x-4 divide-wtf-black">
          ...
          <div className="p-10 md:p-16 flex flex-col justify-start hover:bg-wtf-cream transition-colors duration-300">
            <span className="text-6xl font-black text-wtf-orange mb-6 block">01</span>
            <h3 className="text-2xl font-black uppercase mb-4 tracking-tight">Unaltered Narratives</h3>
            <p className="font-medium text-lg opacity-80 leading-relaxed text-wtf-black">
          ...
          <div className="p-10 md:p-16 flex flex-col justify-start hover:bg-wtf-cream transition-colors duration-300">
            ...
            <h3 className="text-2xl font-black uppercase mb-4 tracking-tight">Deep Intellectual Dives</h3>
            <p className="font-medium text-lg opacity-80 leading-relaxed text-wtf-black">
          ...
          <div className="p-10 md:p-16 flex flex-col justify-start hover:bg-wtf-cream transition-colors duration-300">
            ...
            <h3 className="text-2xl font-black uppercase mb-4 tracking-tight">Focus on Visionaries</h3>
            <p className="font-medium text-lg opacity-80 leading-relaxed text-wtf-black">
